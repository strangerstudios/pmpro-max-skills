...
- Casual phrases welcome ("whole heckuva lot", "literally never")
...
- Long paragraphs that do not scan on mobile
...
- [ ] Hook is compelling in first 1-2 lines
- [ ] Paragraphs are short (mobile-friendly)
- [ ] Content has a clear point or takeaway
